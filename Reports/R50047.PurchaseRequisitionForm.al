Report 50047 PurchaseRequisitionForm
{
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Purchase Header")
        {
            ...
            column(ReqReceiptDate; SCReportUtil.FixDateDDMMYYYY("Expected Receipt Date"))
            {
            }
            ...
            dataitem(Line; "Purchase Line")
            {
                ...
                column(Requested_Receipt_Date_Line; Format("Expected Receipt Date", 0, '<Day,2>-<Month,2>-<Year4>'))
                {
                }
                ...
                begin
                    ...
                    LineAmount := Line.Quantity * Line."Direct Unit Cost" * (1 - Line."Line Discount %" / 100);
                    LineAmountInclVAT := LineAmountInclVAT * (1 + Line."VAT %" / 100);
                    ...
                    TotalAmountVAT += LineAmountInclVAT - LineAmount;
                    TotalAmountInclVAT += LineAmountInclVAT;
                    //TotalPaymentDiscOnVAT += -(LineAmount - "Inv. Discount Amount" - "Amount Including VAT");
    ...
    local procedure GetPurchRcptLines(var PurchRcptHeader: Record "Purchase Header"; var TempPurchRcptLine: Record "Purchase Line" temporary)
    var
    ...
    local procedure GetPurchInvLines(var PurchInvHeader: Record "Purch. Inv. Header"; var TempPurchInvLine: Record "Purch. Inv. Line" temporary)
    var
